...
function scr_project_shadow(argument0, argument1, argument2, argument3) {
			...
			for(var xx=startx;xx<=endx;xx++)
			{
				...
				if(tile == 1)
				{
					...
					if( !sign_test( px1,py1, px2,py1, lx,ly) ){
						scr_project_vertex(VBuffer,  px1,py1, px2,py1, lx,ly, $000000);
					}
					if( !sign_test( px2,py1, px2,py2, lx,ly) ){
						scr_project_vertex(VBuffer,  px2,py1, px2,py2, lx,ly, $000000);
					}
					if( !sign_test( px2,py2, px1,py2, lx,ly) ){
						scr_project_vertex(VBuffer,  px2,py2, px1,py2, lx,ly, $000000);
					}
					if( !sign_test( px1,py2, px1,py1, lx,ly) ){
						scr_project_vertex(VBuffer,  px1,py2, px1,py1, lx,ly, $000000);                      
					}  
				}
			}
		}					
...
function sign_test(argument0, argument1, argument2, argument3, argument4, argument5) {
